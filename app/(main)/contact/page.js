...
// ✅ Fixed Google Map dynamic import (no children issue)
...
// ✅ Static constants moved outside component for optimization
const companyDetails = {
  address: '123 Creativity Lane, Lahore, Punjab, Pakistan',
  phone: '+92 123 456 7890',
  email: 'support@writehub.com',
...
const ContactPage = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setEmail('');
      setMessage('');
      // ✅ Instead of auto-redirect, let user decide
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-200 to-gray-300 text-gray-800 font-sans antialiased">
      ...
      <header className="relative w-full h-[40vh] md:h-[50vh] overflow-hidden">
        ...
        <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4">
          ...
          <Link
            href="/"
            className="mt-4 text-gray-300 hover:text-white transition-colors duration-200"
          >
            Back to Home
          </Link>
        </div>
                ...
                {socialLinks.map((link, index) => {
                  ...
                  return (
                    <Link
                      ...
                      target="_blank"
                      rel="noopener noreferrer"
                      className="bg-gray-100 p-3 rounded-full shadow-sm text-gray-600 hover:text-gray-400 transition-all duration-300 hover:shadow-md"
